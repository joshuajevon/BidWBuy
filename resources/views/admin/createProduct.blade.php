    ...
    <div class="m-5">
        ...
        <form action="{{route('storeProduct')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" value="{{old('slug')}}" class="form-control @error('slug') is-invalid @enderror" id="exampleInputName" name="slug">
              </div>
              ...
              <div class="mb-3">
                ...
                <input type="area" value="{{old('description')}}" class="form-control @error('description') is-invalid @enderror" id="exampleInputName" name="description">
              </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" value="{{old('price')}}" class="form-control @error('price') is-invalid @enderror" id="exampleInputStock" name="price">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" value="{{old('quantity')}}" class="form-control @error('quantity') is-invalid @enderror" id="exampleInputAuthor" name="quantity">
            </div>
